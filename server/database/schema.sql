...
-- =====================================================
-- Uncomment to insert sample exercises
/*
INSERT INTO exercises_library (name, category, muscle_groups, equipment_needed, difficulty_level, instructions, tips) VALUES
('Push-ups', 'strength', ARRAY['chest', 'triceps', 'shoulders'], ARRAY['none'], 'beginner', 'Start in plank position, lower body until chest nearly touches floor, push back up.', 'Keep core tight and body in a straight line.'),
('Squats', 'strength', ARRAY['quadriceps', 'glutes', 'hamstrings'], ARRAY['none'], 'beginner', 'Stand with feet shoulder-width apart, lower hips back and down, return to standing.', 'Keep knees aligned with toes.'),
('Plank', 'strength', ARRAY['core', 'shoulders'], ARRAY['none'], 'beginner', 'Hold body in a straight line from head to heels, supported on forearms and toes.', 'Don''t let hips sag or pike up.'),
('Burpees', 'cardio', ARRAY['full body'], ARRAY['none'], 'intermediate', 'From standing, drop to push-up position, do a push-up, jump feet to hands, jump up.', 'Maintain steady pace and good form throughout.'),
('Deadlifts', 'strength', ARRAY['back', 'glutes', 'hamstrings'], ARRAY['barbell', 'dumbbells'], 'advanced', 'Lift weight from ground by extending hips and knees, keep back straight.', 'Engage core and keep bar close to body.');
*/
